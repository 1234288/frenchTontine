    ...
    suggestions: [
      {
        ...
        link: '/french-tontine/dashboard'
      },
      {
        icon: 'tabler:adjustments-dollar',
        suggestion: 'Transactions',
        link: '/french-tontine/transactions/list'
      },
      {
        icon: 'tabler:brand-cashapp',
        suggestion: 'Points of sale',
        link: '/french-tontine/points-of-sale/list'
      },
      {
        icon: 'tabler:map-pin-dollar',
        suggestion: 'Agencies',
        link: '/french-tontine/agencies/list'
      }
    ]
  },
  {
    ...
    suggestions: [
      ...
      //   suggestion: 'Settings',
      //   link: '/french-tontine/app-settings'
      // },
      {
        icon: 'tabler:users',
        suggestion: 'Users',
        link: '/french-tontine/users/list'
      }
    ]
  }
]
...
const categoryTitle: { [k: string]: string } = {
  ...
  appsPages: 'Partners & Deals',
  userInterface: 'User Interface',
  formsTables: 'Settings',
            ...
            <Box sx={{ top: 0, width: '100%', position: 'sticky' }}>
              <Autocomplete
                ...
                groupBy={(option: AppBarSearchType | unknown) =>
                  searchValue.length ? t(categoryTitle[(option as AppBarSearchType).category]) : ''
                }
                sx={{
                  '& + .MuiAutocomplete-popper': {
                    ...(searchValue.length
                  ...
                  return searchValue.length ? (
                    ...
                    >
                      ...
                      >
                        ...
                        <Typography>{t((option as AppBarSearchType).title)}</Typography>
                      </ListItemButton>
                    </ListItem>
                  ) : null
                }}
