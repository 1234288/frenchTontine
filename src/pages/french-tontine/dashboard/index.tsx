...
// import CashCollectStatistics from 'src/french-tontine/views/dashboard/CashCollectStatistics'
// import CashCollectCongratulations from 'src/french-tontine/views/dashboard/CashCollectCongratulations'
    ...
    <ApexChartWrapper>
      <Grid container spacing={6}>
        {/* <Grid item xs={12} md={4}>
          <CashCollectCongratulations />
        </Grid>
        <Grid item xs={12} md={8}>
          <CashCollectStatistics />
        </Grid> */}
